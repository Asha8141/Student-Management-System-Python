...
def login():
    ...
    elif usernameEntry.get() == "Asha" and passwordEntry.get() == "1234":
...
usernameEntry=Entry(loginFrame,font=('times new roman',20),bd=5)       #,'bold'    ,fg='royalblue'
...
passwordEntry=Entry(loginFrame,font=('times new roman',20),bd=5)       #,'bold'    ,fg='royalblue'
